    ...
    <div className="relative">
      <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
        <DropdownMenuTrigger asChild>
          <button
            className="flex items-center gap-3 px-4 py-2 bg-gray-50 dark:bg-white/[0.03] border border-gray-200 dark:border-gray-800 rounded-xl hover:bg-gray-100 dark:hover:bg-white/[0.05] transition-colors cursor-pointer"
          >
        ...
        <DropdownMenuContent
          align="end"
          className="absolute right-0 mt-2 w-64 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-2 shadow-theme-lg z-50 flex flex-col"
        >
          ...
          <div className="flex flex-col gap-1 max-h-60 overflow-y-auto custom-scrollbar">
            {user.branches.map((branch) => (
              <DropdownMenuItem
                ...
                className={`flex items-center gap-3 w-full px-3 py-2 rounded-xl text-left transition-colors cursor-pointer ${
