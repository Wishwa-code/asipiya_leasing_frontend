    ...
    <div className="relative">
      <DropdownMenu open={isOpen} onOpenChange={handleOpenChange}>
        ...
        <DropdownMenuContent
          align="end"
          sideOffset={17}
          className="flex h-[480px] w-[350px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark sm:w-[361px] z-50"
        >
          ...
          <ul className="flex flex-col h-auto overflow-y-auto custom-scrollbar gap-1">
            <li>
              <DropdownMenuItem
                onClick={closeDropdown}
                className="flex gap-3 rounded-lg border-b border-gray-100 p-3 px-4.5 py-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5 cursor-pointer w-full"
              >
          ...
          <DropdownMenuItem asChild>
            <Link
              to="/"
              onClick={closeDropdown}
              className="block px-4 py-2 mt-3 text-sm font-medium text-center text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 cursor-pointer w-full"
            >
